...
lemma extra:
 ...
 and st5_if12:"((getVarBool st5 ''inp_0'') \<or> (getVarBool st5 ''inp_1''))=True"
...
next
  ...
  proof -
    ...
    proof (simp only: R1A_def; rule impI)
      assume prem:
        "getPstate st0 ''Ctrl'' \<noteq> ''stuckState'' \<and>
        getPstate st0 ''Ctrl'' \<noteq> ''emergency'' \<and>
      ...
      have "(getPstate st0 ''Ctrl'')=''goUp''" using assms by auto
      then have "getVarBool st0 ''out_0''" using extra0 extraInv eGoUpOut_def 0 substate_refl by auto
