...
lemma
 ...
 and st10_if45:"(getVarBool st10 ''_dshcg_gen'')=False"
 and st10_if47:"(((getVarBool st10 ''CycleCh'') \<and> (((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st10 ''SOC'') < (real 1)))=False"
