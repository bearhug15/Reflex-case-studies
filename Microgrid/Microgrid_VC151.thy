...
lemma
 ...
 and st11_if30:"(((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < 550)=False"
 ...
 and st13_if17:"(getVarBool st13 ''_dshcg_gen'')=False"
 and st13_if19:"(((getVarBool st13 ''CycleCh'') \<and> (((getVarReal st13 ''Pl'') - (getVarReal st13 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st13 ''SOC'') < (real 1)))=False"
