...
lemma
 ...
 and st10_if32:"(getPstate st10 ''GeneratorWork'' = ''stop'')=True"
 ...
 and st12_if21:"(getVarBool st12 ''_dshcg_gen'')=False"
 and st12_if23:"(((getVarBool st12 ''CycleCh'') \<and> (((getVarReal st12 ''Pl'') - (getVarReal st12 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st12 ''SOC'') < (real 1)))=False"
