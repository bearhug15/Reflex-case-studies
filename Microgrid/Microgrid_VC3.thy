...
lemma
 ...
 and st8_if1:"(((getVarReal st8 ''Pl'') - (getVarReal st8 ''Pwec'')) < 550)=True"
 ...
 and st9_if1:"(getVarBool st9 ''_dshcg_gen'')=False"
 and st9_if3:"(((getVarBool st9 ''CycleCh'') \<and> (((getVarReal st9 ''Pl'') - (getVarReal st9 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st9 ''SOC'') < (real 1)))=False"
