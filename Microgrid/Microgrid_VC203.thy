...
lemma
 ...
 and st11_if47:"(((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < 550)=True"
 and st12:"(st12=(setVarReal st11 ''RAESdisch'' ((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec''))))"
 and st12_GeneratorWork_state:"(getPstate st12 ''GeneratorWork'')=''control''"
 and st12_if43:"(getVarBool st12 ''_dshcg_gen'')=False"
 and st12_if45:"(((getVarBool st12 ''CycleCh'') \<and> (((getVarReal st12 ''Pl'') - (getVarReal st12 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st12 ''SOC'') < (real 1)))=False"
