...
lemma
 ...
 and st12_if57:"(getVarBool st12 ''_dshcg_gen'')=False"
 and st12_if59:"(((getVarBool st12 ''CycleCh'') \<and> (((getVarReal st12 ''Pl'') - (getVarReal st12 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st12 ''SOC'') < (real 1)))=False"
