...
lemma
 ...
 and st11_if41:"(getVarBool st11 ''_dshcg_gen'')=False"
 and st11_if43:"(((getVarBool st11 ''CycleCh'') \<and> (((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st11 ''SOC'') < (real 1)))=False"
