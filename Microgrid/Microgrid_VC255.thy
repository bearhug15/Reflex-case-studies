...
lemma
 ...
 and st10_if67:"(getPstate st10 ''GeneratorWork'' = ''stop'')=False"
 and st11:"(st11=(setPstate st10 ''RAESdischarging'' ''''stop''''))"
 and st11_GeneratorWork_state:"(getPstate st11 ''GeneratorWork'')=''control''"
 and st11_if59:"(getVarBool st11 ''_dshcg_gen'')=False"
 and st11_if61:"(((getVarBool st11 ''CycleCh'') \<and> (((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st11 ''SOC'') < (real 1)))=False"
