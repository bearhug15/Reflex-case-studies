...
lemma
 ...
 and st9_if30:"(getPstate st9 ''GeneratorWork'' = ''stop'')=True"
 ...
 and st11_if21:"(getVarBool st11 ''_dshcg_gen'')=False"
 and st11_if22:"(((getVarBool st11 ''CycleCh'') \<and> (((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st11 ''SOC'') < (real 1)))=True"
