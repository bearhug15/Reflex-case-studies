...
lemma
 ...
 and st11_if67:"(getPstate st11 ''GeneratorWork'' = ''stop'')=False"
 and st12:"(st12=(setPstate st11 ''RAESdischarging'' ''''stop''''))"
 and st12_GeneratorWork_state:"(getPstate st12 ''GeneratorWork'')=''control''"
 and st12_if65:"(getVarBool st12 ''_dshcg_gen'')=False"
 and st12_if67:"(((getVarBool st12 ''CycleCh'') \<and> (((getVarReal st12 ''Pl'') - (getVarReal st12 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st12 ''SOC'') < (real 1)))=False"
