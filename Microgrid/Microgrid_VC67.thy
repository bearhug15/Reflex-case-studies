...
lemma
 ...
 and st9_if25:"(getVarBool st9 ''_dshcg_gen'')=False"
 and st9_if27:"(((getVarBool st9 ''CycleCh'') \<and> (((getVarReal st9 ''Pl'') - (getVarReal st9 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st9 ''SOC'') < (real 1)))=False"
