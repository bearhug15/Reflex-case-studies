...
lemma
 ...
 and st9_if6:"(((getVarReal st9 ''Pl'') - (getVarReal st9 ''Pwec'')) > 250)=True"
 and st9_if7:"(((getVarReal st9 ''Pl'') - (getVarReal st9 ''Pwec'')) < 550)=True"
 ...
 and st10_if5:"(getVarBool st10 ''_dshcg_gen'')=False"
 and st10_if7:"(((getVarBool st10 ''CycleCh'') \<and> (((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st10 ''SOC'') < (real 1)))=False"
