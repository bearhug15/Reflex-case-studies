...
lemma
 ...
 and st10_if78:"(((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < 550)=False"
 ...
 and st13_if27:"(((getVarBool st13 ''CycleCh'') \<and> (((getVarReal st13 ''Pl'') - (getVarReal st13 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st13 ''SOC'') < (real 1)))=False"
