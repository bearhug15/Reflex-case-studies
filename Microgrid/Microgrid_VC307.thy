...
lemma
 ...
 and st8_if34:"(((getVarReal st8 ''Pl'') - (getVarReal st8 ''Pwec'')) > 250)=True"
 and st8_if36:"(((getVarReal st8 ''Pl'') - (getVarReal st8 ''Pwec'')) < 550)=False"
 ...
 and st11_if75:"(getVarBool st11 ''_dshcg_gen'')=False"
 and st11_if77:"(((getVarBool st11 ''CycleCh'') \<and> (((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st11 ''SOC'') < (real 1)))=False"
