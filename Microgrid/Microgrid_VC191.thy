...
lemma
 ...
 and st11_if41:"(((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) > 250)=False"
 and st12:"(st12=(setVarReal st11 ''RAESdisch'' (real 0)))"
 and st12_if40:"(getPstate st12 ''GeneratorWork'' = ''stop'')=True"
 ...
 and st14_if5:"(getVarBool st14 ''_dshcg_gen'')=False"
 and st14_if7:"(((getVarBool st14 ''CycleCh'') \<and> (((getVarReal st14 ''Pl'') - (getVarReal st14 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st14 ''SOC'') < (real 1)))=False"
