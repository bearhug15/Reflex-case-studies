...
lemma
 ...
 and st10_if38:"(getPstate st10 ''GeneratorWork'' = ''stop'')=True"
 ...
 and st12_if31:"(((getVarBool st12 ''CycleCh'') \<and> (((getVarReal st12 ''Pl'') - (getVarReal st12 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st12 ''SOC'') < (real 1)))=False"
