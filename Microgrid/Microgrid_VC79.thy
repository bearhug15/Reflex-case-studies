...
lemma
 ...
 and st8_if17:"(getVarBool st8 ''_dshcg_gen'')=False"
 and st8_if19:"(((getVarBool st8 ''CycleCh'') \<and> (((getVarReal st8 ''Pl'') - (getVarReal st8 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st8 ''SOC'') < (real 1)))=False"
