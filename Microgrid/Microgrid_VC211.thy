...
lemma
 ...
 and st10_if41:"(((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < 550)=True"
 ...
 and st11_if53:"(getVarBool st11 ''_dshcg_gen'')=False"
 and st11_if55:"(((getVarBool st11 ''CycleCh'') \<and> (((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st11 ''SOC'') < (real 1)))=False"
