...
lemma
 ...
 and st10_if49:"(((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < 550)=True"
 and st11:"(st11=(setVarReal st10 ''RAESdisch'' ((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec''))))"
 and st11_GeneratorWork_state:"(getPstate st11 ''GeneratorWork'')=''control''"
 and st11_if33:"(getVarBool st11 ''_dshcg_gen'')=False"
 and st11_if35:"(((getVarBool st11 ''CycleCh'') \<and> (((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st11 ''SOC'') < (real 1)))=False"
