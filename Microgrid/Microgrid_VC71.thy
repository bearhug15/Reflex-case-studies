...
lemma
 ...
 and st8_if12:"(getPstate st8 ''GeneratorWork'' = ''stop'')=True"
 ...
 and st10_if23:"(((getVarBool st10 ''CycleCh'') \<and> (((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st10 ''SOC'') < (real 1)))=False"
