...
lemma
 ...
 and st14_if10:"(((getVarBool st14 ''CycleCh'') \<and> (((getVarReal st14 ''Pl'') - (getVarReal st14 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st14 ''SOC'') < (real 1)))=True"
 and st15:"(st15=(setVarReal st14 ''RAESch'' 550))"
