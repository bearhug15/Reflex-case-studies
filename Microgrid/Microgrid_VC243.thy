...
lemma
 ...
 and st9_if65:"(((getVarReal st9 ''Pl'') - (getVarReal st9 ''Pwec'')) < 550)=True"
 ...
 and st10_if63:"(getVarBool st10 ''_dshcg_gen'')=False"
 and st10_if65:"(((getVarBool st10 ''CycleCh'') \<and> (((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st10 ''SOC'') < (real 1)))=False"
