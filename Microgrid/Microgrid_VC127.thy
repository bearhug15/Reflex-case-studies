...
lemma
 ...
 and st7_if21:"(getVarBool st7 ''_dshcg_gen'')=False"
 and st7_if23:"(((getVarBool st7 ''CycleCh'') \<and> (((getVarReal st7 ''Pl'') - (getVarReal st7 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st7 ''SOC'') < (real 1)))=False"
 and st8:"(st8=(setVarReal st7 ''Pdg'' ((getVarReal st7 ''Pl'') - (getVarReal st7 ''Pwec''))))"
