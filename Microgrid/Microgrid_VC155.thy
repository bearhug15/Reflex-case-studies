...
lemma
 ...
 and st8_if27:"(getPstate st8 ''GeneratorWork'' = ''stop'')=False"
 and st9:"(st9=(setPstate st8 ''RAESdischarging'' ''''stop''''))"
 and st9_GeneratorWork_state:"(getPstate st9 ''GeneratorWork'')=''control''"
 and st9_if49:"(getVarBool st9 ''_dshcg_gen'')=False"
 and st9_if51:"(((getVarBool st9 ''CycleCh'') \<and> (((getVarReal st9 ''Pl'') - (getVarReal st9 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st9 ''SOC'') < (real 1)))=False"
