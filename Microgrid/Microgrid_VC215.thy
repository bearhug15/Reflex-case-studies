...
lemma
 ...
 and st12_if47:"(getPstate st12 ''GeneratorWork'' = ''stop'')=False"
 and st13:"(st13=(setPstate st12 ''RAESdischarging'' ''''stop''''))"
 and st13_GeneratorWork_state:"(getPstate st13 ''GeneratorWork'')=''control''"
 and st13_if13:"(getVarBool st13 ''_dshcg_gen'')=False"
 and st13_if15:"(((getVarBool st13 ''CycleCh'') \<and> (((getVarReal st13 ''Pl'') - (getVarReal st13 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st13 ''SOC'') < (real 1)))=False"
