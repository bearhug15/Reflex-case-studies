...
lemma
 ...
 and st9_if14:"(((getVarReal st9 ''Pl'') - (getVarReal st9 ''Pwec'')) < 550)=False"
 ...
 and st11_if5:"(getVarBool st11 ''_dshcg_gen'')=False"
 and st11_if7:"(((getVarBool st11 ''CycleCh'') \<and> (((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st11 ''SOC'') < (real 1)))=False"
