...
lemma
 ...
 and st10_if9:"(getPstate st10 ''GeneratorWork'' = ''stop'')=False"
 ...
 and st11_if10:"(((getVarBool st11 ''CycleCh'') \<and> (((getVarReal st11 ''Pl'') - (getVarReal st11 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st11 ''SOC'') < (real 1)))=True"
