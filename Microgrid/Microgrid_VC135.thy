...
lemma
 ...
 and st10_if26:"(((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < 550)=False"
 ...
 and st12_if9:"(getVarBool st12 ''_dshcg_gen'')=False"
 and st12_if11:"(((getVarBool st12 ''CycleCh'') \<and> (((getVarReal st12 ''Pl'') - (getVarReal st12 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st12 ''SOC'') < (real 1)))=False"
