...
lemma
 ...
 and st8_if17:"(((getVarReal st8 ''Pl'') - (getVarReal st8 ''Pwec'')) > 250)=False"
 and st9:"(st9=(setVarReal st8 ''RAESdisch'' (real 0)))"
 and st9_if31:"(getPstate st9 ''GeneratorWork'' = ''stop'')=False"
 and st10:"(st10=(setPstate st9 ''RAESdischarging'' ''''stop''''))"
 and st10_GeneratorWork_state:"(getPstate st10 ''GeneratorWork'')=''control''"
 and st10_if25:"(getVarBool st10 ''_dshcg_gen'')=False"
 and st10_if26:"(((getVarBool st10 ''CycleCh'') \<and> (((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st10 ''SOC'') < (real 1)))=True"
