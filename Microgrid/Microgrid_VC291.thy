...
lemma
 ...
 and st10_if79:"(((getVarReal st10 ''Pl'') - (getVarReal st10 ''Pwec'')) > 250)=False"
 and st11:"(st11=(setVarReal st10 ''RAESdisch'' (real 0)))"
 and st11_if72:"(getPstate st11 ''GeneratorWork'' = ''stop'')=True"
 ...
 and st13_if29:"(getVarBool st13 ''_dshcg_gen'')=False"
 and st13_if31:"(((getVarBool st13 ''CycleCh'') \<and> (((getVarReal st13 ''Pl'') - (getVarReal st13 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st13 ''SOC'') < (real 1)))=False"
