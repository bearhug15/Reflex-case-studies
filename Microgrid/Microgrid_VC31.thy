...
lemma
 ...
 and st9_if9:"(((getVarReal st9 ''Pl'') - (getVarReal st9 ''Pwec'')) > 250)=False"
 and st10:"(st10=(setVarReal st9 ''RAESdisch'' (real 0)))"
 and st10_if8:"(getPstate st10 ''GeneratorWork'' = ''stop'')=True"
 ...
 and st12_if5:"(getVarBool st12 ''_dshcg_gen'')=False"
 and st12_if7:"(((getVarBool st12 ''CycleCh'') \<and> (((getVarReal st12 ''Pl'') - (getVarReal st12 ''Pwec'')) < (1010 * 0.21))) \<and> ((getVarReal st12 ''SOC'') < (real 1)))=False"
