...
lemma
 ...
 and st11_if2:"(\<not>(getVarBool st11 ''inp_0''))=True"
 and st12:"(st12=(setVarBool st11 ''out_0'' False))"
 and st12_FreezerCompressorController_state:"(getPstate st12 ''FreezerCompressorController'')=''checkTemp''"
 and st12_if5:"(getVarBool st12 ''inp_3'')=False"
 and st12_if6:"(\<not>(getVarBool st12 ''inp_2''))=True"
 and st13:"(st13=(setVarBool st12 ''out_1'' False))"
