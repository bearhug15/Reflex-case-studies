...
lemma
 ...
 and st9_if4:"(\<not>(getVarBool st9 ''inp_0''))=True"
 and st10:"(st10=(setVarBool st9 ''out_0'' False))"
 and st10_FreezerCompressorController_state:"(getPstate st10 ''FreezerCompressorController'')=''checkTemp''"
 and st10_if5:"(getVarBool st10 ''inp_3'')=False"
 and st10_if7:"(\<not>(getVarBool st10 ''inp_2''))=False"
