...
assumes base_inv:"inv(st0)"
	...
	and st2_condition_391:"(\<not> ((getVarBool (setVarBool st2 ''inp_1'' False) ''inp_0'') \<and> (getVarBool (setVarBool st2 ''inp_1'' False) ''inp_1'')))"
	...
	and st4_condition_405:"(\<not> (getVarBool st4 ''_turnedOn''))"
	and st5:"st5=(setVarBool st4 ''out_0'' False)"
	and st5_condition_406:"(ltime st5 ''Lighting'' \<ge> 0t11h30m)"
